...
Logic:
  - Installs the current published data-go-kr-client from PyPI into a temp dir
...
Writes new version to pyproject.toml and data_go_kr_client/__init__.py in-place.
...
def get_pypi_version() -> str | None:
    try:
        url = "https://pypi.org/pypi/data-go-kr-client/json"
...
def update_files(new_ver: str) -> None:
    replacements = [
        ...
        (
            ROOT / "data_go_kr_client" / "__init__.py",
            r'(__version__\s*=\s*")[^"]+(")',
        ),
    ]
