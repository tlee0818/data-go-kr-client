# data-go-kr-client — First-Run Setup
...
Go to: **https://github.com/tlee0818/data-go-kr-client/settings/pages**

- Source: **GitHub Actions**

Required for the Docs workflow to deploy API reference to `https://tlee0818.github.io/data-go-kr-client/`.
...
1. Create a fine-grained PAT at **https://github.com/settings/tokens**
   - Repository access: `tlee0818/data-go-kr-client`
   - Permissions: **Contents → Read and write**
2. Add it as a repo secret named `PAT`:

```bash
gh secret set PAT --repo tlee0818/data-go-kr-client
```
...
| Field | Value |
|-------|-------|
| PyPI project name | `data-go-kr-client` |
| Owner | `tlee0818` |
| Repository | `data-go-kr-client` |
...
```bash
gh run list --repo tlee0818/data-go-kr-client --limit 5
```
